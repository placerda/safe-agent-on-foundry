...
Do not use the sample policy or evidence token unchanged in production. Store
the signing secret in a managed secret service and add expiry, nonce and replay
protection, audience binding, key rotation, and durable audit correlation.
